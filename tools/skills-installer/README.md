...
- Каталог актуальных travel-навыков из эталонного Obsidian-вольта: архитектура, маршрут, логистика, бюджетный аудит, культура, тропы, безопасность, workation и совместимость с импортёром, а также системные правила.
