...
> - 📱 **Связь и страховка (e-SIM 5G безлимит, полис ВЗР с активным спортом):** `~X XXX ₽`
...
*См. детальный каталог в файле «Отели.md». Средняя стоимость: `~X XXX ₽ / ночь`.*
