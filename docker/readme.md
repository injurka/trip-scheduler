...
./docker/build_server.sh v27

docker compose down

V_CLIENT=v26 V_SERVER=v27 docker compose up -d
...
docker tag trip-scheduler-server:v27 injurka/trip-scheduler-server:v27
docker push injurka/trip-scheduler-server:v27
