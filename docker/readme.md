...
./docker/build_client.sh v57
./docker/build_server.sh v46

docker compose down

V_CLIENT=v57 V_SERVER=v45 docker compose up -d

---

docker tag trip-scheduler-client:v57 injurka/trip-scheduler-client:v57
docker push injurka/trip-scheduler-client:v57
