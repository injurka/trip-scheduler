...
ALTER TABLE "post_media" ADD CONSTRAINT "post_media_element_id_post_elements_id_fk" FOREIGN KEY ("element_id") REFERENCES "public"."post_elements"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "post_images_post_id_idx" ON "post_media" USING btree ("post_id");--> statement-breakpoint
CREATE INDEX "post_images_element_id_idx" ON "post_media" USING btree ("element_id");--> statement-breakpoint
CREATE INDEX "posts_city_idx" ON "posts" USING btree ("country");--> statement-breakpoint
