...
function buildSystemPrompt(input: GenerateAiTripInput, feedback?: string): string {
  ...
  return [
    ...
    `- "05 - Полезная информация/Полезная информация.md"`,
    `- "06 - Чек лист/Чек лист.md", "06 - Чек лист/Чек-лист подготовки и сборов.md", "06 - Чек лист/Что попробовать и купить (Must-Try & Must-Buy).md"`,
